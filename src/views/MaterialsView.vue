...
<template>
  <div class="page">
    <div class="page-header">
      ...
      <div v-if="!stocktaking" class="header-actions">
        <el-button @click="historyVisible = true">
          <el-icon><Document /></el-icon>&nbsp;盘点记录
        </el-button>
        <el-button type="warning" plain @click="startStocktake">
          <el-icon><Checked /></el-icon>&nbsp;盘点模式
        </el-button>
    ...
    <StocktakePanel v-if="stocktaking" @exit="stocktaking = false" />
